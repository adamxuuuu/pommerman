...
public class MyTreeNode {
    ...
    void mctsSearch(ElapsedCpuTimer elapsedTimer) {
        ...
        while(!stop){
            ...
            MyTreeNode selected = treePolicy(state);
    ...
    private MyTreeNode treePolicy(GameState state) {
    ...
    private MyTreeNode expand(GameState state) {
    ...
    private MyTreeNode uct(GameState state) {
